								...
								<div class="form-group met-upfile">
									<div class="row">
										...
										<div class="col-md-6 form-group">
											<input type="file" name="head" value="<?php echo $set_user_head;?>" data-plugin='fileinput' data-url="<?php echo $_M['url']['site'];?>app/system/entrance.php?lang=<?php echo $_M['lang'];?>&c=uploadify&m=include&a=dohead" accept='image/*' hidden/>
										</div>
									</div>
								</div>
